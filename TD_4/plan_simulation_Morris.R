#----------------------------------------------------------------------------------#
#-----------------------------SENSITIVITY ANALYSIS WITH VARIABLE DENSITY-----------------------------##
#----------------------------------------------------------------------------------#
...
#Directory
Directory='/home/perez/Documents/Enseignement/supagro_training_2018/TD_4/'
...
###save the file
filename=paste0('planMorris','_area',plant_area,'_s',stage,'_d',density)
plan=as.data.frame(planMorris)

plan$plant_area=plant_area
plan$stage=stage
plan$density=density

write.csv(x=planMorris,file =paste0(Directory,filename,'.csv'),row.names = F)
